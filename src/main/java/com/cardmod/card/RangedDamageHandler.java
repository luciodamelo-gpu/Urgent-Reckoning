...
public final class RangedDamageHandler {
    ...
    public static void onHurt(LivingHurtEvent event) {
        ...
        ResourceLocation sg = new ResourceLocation("cardmod","sharpshooters_grip");
        ResourceLocation de = new ResourceLocation("cardmod","deadeye");
        ...
        int sgCount = CardCapability.getCount(player, sg);
        int deCount = CardCapability.getCount(player, de);
        ...
        if (sgCount > 0) bonus += 0.10f * sgCount;
        if (deCount > 0) bonus += 0.15f * deCount;
